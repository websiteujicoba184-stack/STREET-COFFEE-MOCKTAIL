...
<head>
    <meta charset="UTF-8">
    <title>Login - Street Coffee Mocktail</title>
    <style>
        body {
            margin: 0;
            padding: 0;
        ...
        /* Latar semi-transparan agar form tetap jelas */
        body::before {
            content: "";
            position: fixed;
            top: 0; left: 0;
...
<body>
    <div class="form-container">
        ...
        <img src="{{ asset('images/worker_icon.png') }}" class="worker-icon" onclick="window.location.href='/login/pekerja'" title="Login Pekerja">
        ...
        <p>Belum punya akun? <a href="/register" class="switch-link">Daftar di sini</a></p>
